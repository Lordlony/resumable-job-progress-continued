...
namespace ResumableJobProgress
{
	class ResumeDictionary
	{
		...
		private Dictionary<(Thing, Def), (float, float)> resumeJobWorkDones = new Dictionary<(Thing, Def), (float, float)>();
		...
		private Dictionary<(Map, IntVec3, ThingDef), float> resumeSowJobWorkDones = new Dictionary<(Map, IntVec3, ThingDef), float>();
		...
		private Dictionary<(RecipeDef, Building_WorkTable), (List<ThingDef>, float)> resumeBillWorkLefts = new Dictionary<(RecipeDef, Building_WorkTable), (List<ThingDef>, float)>();
